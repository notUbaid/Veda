...
const MEDICINES = [
  ...
  { name: 'Ibuprofen 400mg',    genericName: 'Ibuprofen',              category: 'Analgesic',        unit: 'Tablets',  unitPrice: 3.5,   reorderThreshold: 300, leadTimeDays: 3, supplier: 'Cipla'        },
  { name: 'Diclofenac Gel 30g', genericName: 'Diclofenac Diethylamine',category: 'Analgesic',        unit: 'Tubes',    unitPrice: 45.0,  reorderThreshold: 100, leadTimeDays: 4, supplier: 'Novartis'     },
  { name: 'Ceftriaxone 1g',     genericName: 'Ceftriaxone Sodium',     category: 'Antibiotic',       unit: 'Vials',    unitPrice: 55.0,  reorderThreshold: 150, leadTimeDays: 5, supplier: 'Alkem'        },
  { name: 'Ranitidine 150mg',   genericName: 'Ranitidine HCI',         category: 'Antacid',          unit: 'Tablets',  unitPrice: 2.0,   reorderThreshold: 400, leadTimeDays: 3, supplier: 'Zydus'        },
  { name: 'Losartan 50mg',      genericName: 'Losartan Potassium',     category: 'Cardiac',          unit: 'Tablets',  unitPrice: 6.0,   reorderThreshold: 200, leadTimeDays: 4, supplier: 'Sun Pharma'   },
  { name: 'Levothyroxine 50mcg',genericName: 'Levothyroxine',          category: 'Endocrine',        unit: 'Tablets',  unitPrice: 1.5,   reorderThreshold: 250, leadTimeDays: 4, supplier: 'Abbott'       },
  { name: 'Dexamethasone 0.5mg',genericName: 'Dexamethasone',          category: 'Steroid',          unit: 'Tablets',  unitPrice: 1.0,   reorderThreshold: 400, leadTimeDays: 3, supplier: 'Cadila'       },
  { name: 'Clopidogrel 75mg',   genericName: 'Clopidogrel',            category: 'Cardiac',          unit: 'Tablets',  unitPrice: 12.0,  reorderThreshold: 150, leadTimeDays: 5, supplier: 'Torrent'      },
  { name: 'Aspirin 75mg',       genericName: 'Acetylsalicylic Acid',   category: 'Cardiac',          unit: 'Tablets',  unitPrice: 1.2,   reorderThreshold: 500, leadTimeDays: 3, supplier: 'Bayer'        },
  { name: 'Metoprolol 50mg',    genericName: 'Metoprolol Succinate',   category: 'Cardiac',          unit: 'Tablets',  unitPrice: 5.5,   reorderThreshold: 200, leadTimeDays: 4, supplier: 'Lupin'        },
  { name: 'Alprazolam 0.5mg',   genericName: 'Alprazolam',             category: 'Psychiatric',      unit: 'Tablets',  unitPrice: 3.0,   reorderThreshold: 100, leadTimeDays: 4, supplier: 'Intas'        },
  { name: 'Acyclovir 400mg',    genericName: 'Acyclovir',              category: 'Antiviral',        unit: 'Tablets',  unitPrice: 15.0,  reorderThreshold: 150, leadTimeDays: 6, supplier: 'GSK'          },
  { name: 'Tramadol 50mg',      genericName: 'Tramadol HCI',           category: 'Analgesic',        unit: 'Capsules', unitPrice: 8.0,   reorderThreshold: 200, leadTimeDays: 5, supplier: 'Mankind'      },
  { name: 'Montelukast 10mg',   genericName: 'Montelukast Sodium',     category: 'Respiratory',      unit: 'Tablets',  unitPrice: 14.0,  reorderThreshold: 180, leadTimeDays: 4, supplier: 'Glenmark'     },
  { name: 'Chlorpheniramine 4mg',genericName: 'Chlorpheniramine',      category: 'Antihistamine',    unit: 'Tablets',  unitPrice: 1.5,   reorderThreshold: 300, leadTimeDays: 3, supplier: 'Cipla'        },
  { name: 'Iron Syrup 200ml',   genericName: 'Ferrous Ascorbate',      category: 'Supplement',       unit: 'Bottles',  unitPrice: 110.0, reorderThreshold: 50,  leadTimeDays: 5, supplier: 'Emcure'       },
  { name: 'Calcium + D3 500mg', genericName: 'Calcium Carbonate',      category: 'Supplement',       unit: 'Tablets',  unitPrice: 4.5,   reorderThreshold: 400, leadTimeDays: 3, supplier: 'Micro Labs'   },
  { name: 'B-Complex Injection',genericName: 'Vitamin B Complex',      category: 'Supplement',       unit: 'Ampoules', unitPrice: 12.0,  reorderThreshold: 100, leadTimeDays: 5, supplier: 'Zydus'        },
  { name: 'Doxycycline 100mg',  genericName: 'Doxycycline Hyclate',    category: 'Antibiotic',       unit: 'Capsules', unitPrice: 6.0,   reorderThreshold: 200, leadTimeDays: 4, supplier: 'USV'          },
  { name: 'Cefixime 200mg',     genericName: 'Cefixime Trihydrate',    category: 'Antibiotic',       unit: 'Tablets',  unitPrice: 18.5,  reorderThreshold: 150, leadTimeDays: 5, supplier: 'Alkem'        },
  { name: 'Ciprofloxacin 500mg',genericName: 'Ciprofloxacin HCI',      category: 'Antibiotic',       unit: 'Tablets',  unitPrice: 7.0,   reorderThreshold: 250, leadTimeDays: 4, supplier: 'Bayer'        },
  { name: 'Prednisolone 5mg',   genericName: 'Prednisolone',           category: 'Steroid',          unit: 'Tablets',  unitPrice: 2.0,   reorderThreshold: 300, leadTimeDays: 3, supplier: 'Pfizer'       },
  { name: 'Ofloxacin 200mg',    genericName: 'Ofloxacin',              category: 'Antibiotic',       unit: 'Tablets',  unitPrice: 9.0,   reorderThreshold: 200, leadTimeDays: 4, supplier: 'Macleods'     },
  { name: 'Mefenamic Acid 250mg',genericName: 'Mefenamic Acid',        category: 'Analgesic',        unit: 'Tablets',  unitPrice: 4.2,   reorderThreshold: 250, leadTimeDays: 3, supplier: 'Blue Cross'   },
  { name: 'Multivitamin Gold',  genericName: 'Multivitamins + Min',    category: 'Supplement',       unit: 'Capsules', unitPrice: 8.5,   reorderThreshold: 300, leadTimeDays: 5, supplier: 'Pfizer'       },
];
...
function batches(pfx: string) {
  return [
    ...
    { mi:15, bn:`B-IBU-${pfx}01`, qty:800,  exp:dF(300), pp:2.5,   loc:{aisle:'D',row:'1',shelf:'1',compartment:'1'} },
    { mi:16, bn:`B-DIC-${pfx}01`, qty:200,  exp:dF(180), pp:35.0,  loc:{aisle:'D',row:'1',shelf:'2',compartment:'1'} },
    { mi:17, bn:`B-CEF-${pfx}01`, qty:350,  exp:dF(90),  pp:45.0,  loc:{aisle:'D',row:'2',shelf:'1',compartment:'1'} },
    { mi:18, bn:`B-RAN-${pfx}01`, qty:1000, exp:dF(400), pp:1.5,   loc:{aisle:'D',row:'2',shelf:'2',compartment:'1'} },
    { mi:19, bn:`B-LOS-${pfx}01`, qty:450,  exp:dF(200), pp:4.8,   loc:{aisle:'D',row:'3',shelf:'1',compartment:'1'} },
    { mi:20, bn:`B-LEV-${pfx}01`, qty:600,  exp:dF(150), pp:1.0,   loc:{aisle:'D',row:'3',shelf:'2',compartment:'1'} },
    { mi:21, bn:`B-DEX-${pfx}01`, qty:800,  exp:dF(250), pp:0.8,   loc:{aisle:'E',row:'1',shelf:'1',compartment:'1'} },
    { mi:22, bn:`B-CLO-${pfx}01`, qty:300,  exp:dF(180), pp:9.5,   loc:{aisle:'E',row:'1',shelf:'2',compartment:'1'} },
    { mi:23, bn:`B-ASP-${pfx}01`, qty:1200, exp:dF(365), pp:0.9,   loc:{aisle:'E',row:'2',shelf:'1',compartment:'1'} },
    { mi:24, bn:`B-METP-${pfx}01`,qty:400,  exp:dF(200), pp:4.2,   loc:{aisle:'E',row:'2',shelf:'2',compartment:'1'} },
    { mi:25, bn:`B-ALP-${pfx}01`, qty:250,  exp:dF(150), pp:2.0,   loc:{aisle:'E',row:'3',shelf:'1',compartment:'1'} },
    { mi:26, bn:`B-ACY-${pfx}01`, qty:300,  exp:dF(300), pp:12.0,  loc:{aisle:'E',row:'3',shelf:'2',compartment:'1'} },
    { mi:27, bn:`B-TRA-${pfx}01`, qty:450,  exp:dF(180), pp:6.5,   loc:{aisle:'F',row:'1',shelf:'1',compartment:'1'} },
    { mi:28, bn:`B-MON-${pfx}01`, qty:380,  exp:dF(210), pp:11.0,  loc:{aisle:'F',row:'1',shelf:'2',compartment:'1'} },
    { mi:29, bn:`B-CHL-${pfx}01`, qty:700,  exp:dF(400), pp:1.0,   loc:{aisle:'F',row:'2',shelf:'1',compartment:'1'} },
    { mi:30, bn:`B-IRO-${pfx}01`, qty:120,  exp:dF(120), pp:95.0,  loc:{aisle:'F',row:'2',shelf:'2',compartment:'1'} },
    { mi:31, bn:`B-CAL-${pfx}01`, qty:850,  exp:dF(250), pp:3.5,   loc:{aisle:'F',row:'3',shelf:'1',compartment:'1'} },
    { mi:32, bn:`B-BCM-${pfx}01`, qty:250,  exp:dF(100), pp:9.0,   loc:{aisle:'F',row:'3',shelf:'2',compartment:'1'} },
    { mi:33, bn:`B-DOX-${pfx}01`, qty:400,  exp:dF(160), pp:4.5,   loc:{aisle:'G',row:'1',shelf:'1',compartment:'1'} },
    { mi:34, bn:`B-CEX-${pfx}01`, qty:350,  exp:dF(200), pp:14.0,  loc:{aisle:'G',row:'1',shelf:'2',compartment:'1'} },
    { mi:35, bn:`B-CIP-${pfx}01`, qty:500,  exp:dF(250), pp:5.5,   loc:{aisle:'G',row:'2',shelf:'1',compartment:'1'} },
    { mi:36, bn:`B-PRE-${pfx}01`, qty:600,  exp:dF(300), pp:1.5,   loc:{aisle:'G',row:'2',shelf:'2',compartment:'1'} },
    { mi:37, bn:`B-OFL-${pfx}01`, qty:450,  exp:dF(150), pp:7.0,   loc:{aisle:'G',row:'3',shelf:'1',compartment:'1'} },
    { mi:38, bn:`B-MEF-${pfx}01`, qty:550,  exp:dF(240), pp:3.2,   loc:{aisle:'G',row:'3',shelf:'2',compartment:'1'} },
    { mi:39, bn:`B-MUL-${pfx}01`, qty:800,  exp:dF(365), pp:6.5,   loc:{aisle:'G',row:'4',shelf:'1',compartment:'1'} },
  ];
}
